...
- Smart suggestions based on the selected scenario
- Prediction Lab for comparing multiple runs
- Download latest prediction report
- Download saved lab results as CSV
